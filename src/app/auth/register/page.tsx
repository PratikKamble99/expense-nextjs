      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="card-elevated p-8 text-center">
            <div className="mx-auto w-16 h-16 rounded-2xl bg-tertiary/12 flex items-center justify-center mb-5">
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-on-surface-variant mt-1">Join Luminescent Ledger for free</p>
        </div>
        ...
        <div className="card-elevated p-8 space-y-5">
          ...
          <p className="text-center text-sm text-on-surface-variant">
            ...
            <Link href="/auth/login" className="text-primary font-medium hover:text-primary-container transition-colors">
              Sign in
            </Link>
          </p>
        </div>
